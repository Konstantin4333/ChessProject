...
namespace Chess.Models
{
    public class Board
    {
        ...
        public void resetBoard()
        {
            ...
            Squares[6][0] = new Square(1, 0, new Pawn(false));
            Squares[6][1] = new Square(1, 1, new Pawn(false));
            Squares[6][2] = new Square(1, 2, new Pawn(false));
            Squares[6][3] = new Square(1, 3, new Pawn(false));
            Squares[6][4] = new Square(1, 4, new Pawn(false));
            Squares[6][5] = new Square(1, 5, new Pawn(false));
            Squares[6][6] = new Square(1, 6, new Pawn(false));
            Squares[6][7] = new Square(1, 7, new Pawn(false));
