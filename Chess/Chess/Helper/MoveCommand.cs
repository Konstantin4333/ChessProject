    ...
    public static class MoveCommand 
    {
        ...
        public static List<Square> SelectPieceMovement(List<Square> Squares ,Piece CurrentPiece, Square start)
        {
            ...
            switch (variable)
            {
                case "King":
                    {
                        MoveCommand.SelectPathKing(Squares, AvailableMoves, start);
                      //  KingChecker(Squares, AvailableMoves, CurrentPiece);
                    }
                    break;
                case "Queen":
                    {
                        MoveCommand.SelectPathBishop(Squares, AvailableMoves, start);
                        MoveCommand.SelectPathRook(Squares, AvailableMoves, start);
                ...
                case "Pawn":
                    {
                        MoveCommand.SelectPathPawn(Squares, AvailableMoves, start);
                    }
                    break;
                case "Knight":
                    {
                        MoveCommand.SelectPathKnight(Squares, AvailableMoves, start);
                    }
                    break;
            }
